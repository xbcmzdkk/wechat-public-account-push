...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe33603c284551b0b',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '1ab7379c830128508b7f6aa7ef352f37',
  ...
  USERS: [
    {
      ...
      id: 'oUWVF6Gskmb7iKdFoqTewZ5FDG4I',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '3lROY8AbrFFqVe8kCO-mu10En3ys1aQeIs6Xui1PZkQ',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '新余',
...
',
  ...
  CALLBACK_TEMPLATE_ID: 'ldz9qfaY50dWEr90uceRLJB6IA66eT7owGIOIgL9PXA',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oUWVF6FslVcmKTCJ-WVdvh9dIMIw',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
